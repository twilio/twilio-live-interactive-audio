...
base64 -D <<< $DISTRIBUTION_PROVISIONING_PROFILE -o ~/Library/MobileDevice/Provisioning\ Profiles/distribution.mobileprovision
base64 -D <<< $DEVELOPMENT_PROVISIONING_PROFILE -o ~/Library/MobileDevice/Provisioning\ Profiles/development.mobileprovision
